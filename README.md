...
They are similar, but a method is a property of an object while a function is not.
...
super() is used to tell a parent's constructor to be concerned with the child's attributes and abstracts away Object.create(this, Class)
